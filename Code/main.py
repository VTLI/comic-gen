...
from utils import pp, visualize, to_json, show_all_variables, expand_path, timestamp, make_gif
...
flags.DEFINE_integer("input_width", 263, "The size of image to use (will be center cropped). If None, same value as input_height [None]")
flags.DEFINE_integer("output_height", 400, "The size of the output images to produce [64]")
flags.DEFINE_integer("output_width", 263, "The size of the output images to produce. If None, same value as output_height [None]")
flags.DEFINE_string("dataset", "Resized", "The name of dataset [Earth X]")
flags.DEFINE_string("input_fname_pattern", "*.jpg", "Glob pattern of filename of input images [*]")
flags.DEFINE_string("data_dir", "E:/Comics", "path to datasets [e.g. $HOME/data]")
...
flags.DEFINE_boolean("gif", False, "True for visualizing, False for nothing [False]")
